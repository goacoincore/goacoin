...
{
    const char* pszTimestamp = "25/Nov/2017 The Goan - Sparks fly over move to create more PDAs";
    const CScript genesisOutputScript = CScript() << ParseHex("0471b3ee7046e13c539c8c198d3646dff82f5e0b014bac9d31d39393302c10d264c4a5d879fd0e3ee036335fcef067c82f4b3396ebdd7bf95857994e3e815bede6") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000003188d3d8c8416f376ac5d2076bb19edfee547e3d2751ae8069d147ddd3d"));
        assert(genesis.hashMerkleRoot == uint256S("0xe3e68ec47646adf2b50b59b237ace98c9f77e2defc8509ce83db6f8fcc12c5b5"));
...
//        vSeeds.clear();
        ...
        // GoaCoin script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // GoaCoin private keys start with '5' or 'G' (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,198);
        // GoaCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
	    ...
	    (130000, uint256S("0x0000000141348631107e4c83629fa12070999d303e0ae95707a5f19ffde0aee8"))
	    (133100, uint256S("0x000000011f1310c0aae1d02f3eae374e70d195a9992d164dd492b5c058afed67")),
            1534776361, // * UNIX timestamp of last checkpoint block
            173459,    //  total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000303eea26c9f8ca17720a61c5758a10050a98512c9f683900b8c0958b4ff"));
        assert(genesis.hashMerkleRoot == uint256S("0xe3e68ec47646adf2b50b59b237ace98c9f77e2defc8509ce83db6f8fcc12c5b5"));
        ...
        // Testnet GoaCoin script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Testnet GoaCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000303eea26c9f8ca17720a61c5758a10050a98512c9f683900b8c0958b4ff")),
	     1511611201, // * UNIX timestamp of last checkpoint block
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1511611202, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x422a8d15baf6128e493fcb5c63f35856d6d7b93da022fade92c103547066138a"));
        assert(genesis.hashMerkleRoot == uint256S("0xe3e68ec47646adf2b50b59b237ace98c9f77e2defc8509ce83db6f8fcc12c5b5"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x422a8d15baf6128e493fcb5c63f35856d6d7b93da022fade92c103547066138a")),
            0,
            0,
            0
        };
        // Regtest GoaCoin addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Regtest GoaCoin script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest GoaCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
