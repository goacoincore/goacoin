...
{
    if(fLiteMode) return; // ignore all GoaCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat GoaCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("goacoin-privatesend");
