...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GoaCoinCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GoaCoinCore
    // Mac: ~/Library/Application Support/GoaCoinCore
    // Unix: ~/.goacoincore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GoaCoinCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GoaCoinCore";
#else
    // Unix
