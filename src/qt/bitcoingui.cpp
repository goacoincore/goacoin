    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("GoaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GoaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goacoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GoaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about GoaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GoaCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GoaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GoaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a goacoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GoaCoin Core help message to get a list with possible GoaCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("GoaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoaCoin network", "", count));
}
...
{
    QString strTitle = tr("GoaCoin Core"); // default title
