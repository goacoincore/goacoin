    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GoaCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About GoaCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  goacoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GoaCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GOA, 0.1 GOA, 1 GOA and 10 GOA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://goacoincore.atlassian.net/wiki/display/DOC/PrivateSend\">https://goacoincore.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GoaCoin Core is shutting down...") + "<br /><br />" +
