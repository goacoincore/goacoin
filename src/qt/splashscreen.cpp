    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("GoaCoin Core");
    QString versionText     = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightTextBtc   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin Core developers"));
    QString copyrightTextDash   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dash Core developers"));
    QString copyrightTextGoaCoin   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The GoaCoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+24,copyrightTextGoaCoin);
