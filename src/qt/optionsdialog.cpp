    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GOA-light"), QVariant("light"));
    ui->theme->addItem(QString("GOA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GOA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GOA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GOA-traditional"), QVariant("trad"));
