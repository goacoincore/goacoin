...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GoaCoinNetwork") type = GoaCoinNetwork;
    if(strType == "GoaCoinNetworkVariable") type = GoaCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GoaCoinNetwork) s = "GoaCoinNetwork";
    if(type == GoaCoinNetworkVariable) s = "GoaCoinNetworkVariable";
