...
This mechanism has been integrated into Bitcore-Node-GoaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/goacoincoin/insight-api-goacoin#web-socket-api](https://github.com/goacoincoin/insight-api-goacoin#web-socket-api) 
* API: [https://github.com/goacoincoin/insight-api-goacoin#instantsend-transactions](https://github.com/goacoincoin/insight-api-goacoin#instantsend-transactions) 
...
By default, the GoaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GoaCoin Core daemon:
