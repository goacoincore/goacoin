...
Only requiring some minor changes is goacoin.cpp.
...
Changes to goacoin.cpp
----------------------
goacoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
